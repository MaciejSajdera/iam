 ...
 */
function am_scripts() {
	wp_enqueue_style( 'am-style', get_template_directory_uri() . '/dist/css/style.css', array(), '10.92');
	wp_enqueue_script( 'am-app', get_template_directory_uri() . '/dist/js/main.js', array(), '10.92', true );
